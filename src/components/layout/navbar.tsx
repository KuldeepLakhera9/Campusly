    ...
    <header className="sticky top-0 z-40 w-full bg-campus-bg/90 backdrop-blur-md border-b border-campus-border transition-colors">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="hidden sm:flex items-center gap-1.5 px-2 py-0.5 rounded-full bg-campus-muted-bg text-campus-muted border border-campus-border text-[11px] font-medium tracking-wide">
        ...
        <div className="flex items-center gap-2.5">
          ...
          >
            ...
            <div className="hidden lg:block text-left">
              <span className="block text-xs font-semibold text-campus-charcoal leading-none">
                Library Fox
              </span>
